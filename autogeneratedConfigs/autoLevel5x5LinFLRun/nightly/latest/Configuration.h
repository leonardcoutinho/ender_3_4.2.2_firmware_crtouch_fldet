...
#define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3, zisismaras, leonardcoutinho)" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -10, -0.9 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define X_BED_SIZE 230 //ORIGINAL: #define X_BED_SIZE 235
#define Y_BED_SIZE 230 //ORIGINAL: #define Y_BED_SIZE 235

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -9 //ORIGINAL: #define Y_MIN_POS 0
#define Z_MIN_POS 0
...
#define FILAMENT_RUNOUT_SENSOR //ORIGINAL: //#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_STATE HIGH //ORIGINAL:   #define FIL_RUNOUT_STATE     LOW        // Pin state indicating that filament is NOT present.
