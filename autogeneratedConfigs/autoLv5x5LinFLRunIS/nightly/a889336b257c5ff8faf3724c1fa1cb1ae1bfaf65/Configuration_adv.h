 ...
 */
#define INPUT_SHAPING_X //ORIGINAL: //#define INPUT_SHAPING_X
#define INPUT_SHAPING_Y //ORIGINAL: //#define INPUT_SHAPING_Y
//#define INPUT_SHAPING_Z
  ...
  #define SHAPING_MENU //ORIGINAL:   //#define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters.
#endif
...
#define LIN_ADVANCE //ORIGINAL: //#define LIN_ADVANCE
    ...
    #define ADVANCE_K 0.22 //ORIGINAL:     #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.22 //ORIGINAL:     #define ADVANCE_K 0.22        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT 15 //ORIGINAL:   //#define PROBING_MARGIN_LEFT PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT 15 //ORIGINAL:   //#define PROBING_MARGIN_RIGHT PROBING_MARGIN
